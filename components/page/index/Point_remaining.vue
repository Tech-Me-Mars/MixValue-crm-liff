...
<template>
            ...
            <p class="mb-3 text-lime-700 text-2xl font-bold">{{ cardMemberData.point }}</p>
            <p class="text-semibold text-sm text-red-600 mb-3 font-bold"><span class="text-green-700">{{ cardMemberData.point_expire_date }} แต้ม
                </span>{{ $t('จะหมดอายุใน') }} {{ cardMemberData.point_expire_date }}</p>
