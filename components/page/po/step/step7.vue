            ...
            <div class="grid grid-cols-2 gap-4 px-4 card">
                ...
                <div class="col-span-2">
                    <div class="overflow-x-auto">
                        <Timeline :value="timeLine" class="items-center" layout="horizontal" align="top" :pt="{
                            root: { class: '' },
                            opposite: { class: 'w-[12rem]' },
                        }">
                            <template #opposite="slotProps">
                                <small class="p-text-secondary">{{
                                    slotProps.item.po_status_name
                                }}</small>
                            </template>
...
const loadDataPo = async () => {
    try {
        ...
        timeLine.value = dataPo.value.po_tracking_time_line;
    } catch (error) {
        console.error(error)
    }
}
